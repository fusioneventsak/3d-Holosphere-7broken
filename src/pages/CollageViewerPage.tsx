...
import { Share2, Upload, Edit, Maximize2, ChevronLeft, RefreshCw } from 'lucide-react';
...
const CollageViewerPage: React.FC = () => {
  ...
  }, [currentCollage, loading, error, isRealtimeConnected, photos.length]);

  // Set up auto-refresh interval
  useEffect(() => {
    if (currentCollage?.id && autoRefreshEnabled && !isRealtimeConnected) {
      console.log('🔄 Setting up auto-refresh interval (every 5 seconds)');
  ...
  }, [currentCollage?.id, autoRefreshEnabled, isRealtimeConnected, refreshPhotos]);
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2 text-gray-400 text-sm">
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        {!isRealtimeConnected && (
                          <span className="text-xs text-gray-500 ml-1">(Auto-refresh every 5s)</span>
                        )}
                      </div>
                    </div>
                  </div>
